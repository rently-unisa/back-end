...
public class GestioneNoleggioControllerTests {
    ...
    void testGetRichiesteByNoleggiante() throws Exception {
        ...
        Noleggio mockNoleggio1 = new Noleggio(1,Noleggio.EnumStato.RICHIESTA, new BigDecimal("100.00"), Date.valueOf("2024-02-01"), Date.valueOf("2024-02-07"), Date.valueOf("2024-01-28"), mockUtente1, mockUtente2, mockAnnuncio1);
    ...
    @Test
    @WithMockUser(username = "user1", roles = {"USER"})
    void testGetRichiesteByNoleggianteReturnServerError() throws Exception {
