...
public class databasePopulator implements CommandLineRunner {
    ...
    public void run(String... strings) throws Exception {
        ...
        Annuncio annuncio9 = new Annuncio(9,"Auto Fiat Punto", "Via Garibaldi", "Catania", "95121", "Fiat Punto 2018, benzina", new BigDecimal("300.00"), "img9.jpg", Annuncio.EnumCategoria.AUTOEMOTO, Annuncio.EnumCondizione.DISCRETA, Date.valueOf("2025-05-12"), user13, null, null);
