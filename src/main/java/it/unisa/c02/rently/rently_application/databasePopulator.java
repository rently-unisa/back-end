...
public class databasePopulator implements CommandLineRunner {
    ...
    public void run(String... strings) throws Exception {
        ...
        Annuncio annuncio1 = new Annuncio(1l,"Smartphone Samsung", "Via Roma", "Milan", "97534", "Telefono in ottime condizioni", new BigDecimal("30.00"), "img1.jpg", Annuncio.EnumCategoria.ELETTRONICA, Annuncio.EnumCondizione.OTTIMA, Date.valueOf("2024-10-05"), user2, null, null);
        Annuncio annuncio2 = new Annuncio(2l,"Libro di Fantascienza", "Corso Magenta", "Torin", "10123", "Romanzo di Isaac Asimov", new BigDecimal("5.00"), "img2.jpg", Annuncio.EnumCategoria.LIBRI, Annuncio.EnumCondizione.BUONA, Date.valueOf("2024-11-15"), user2, null, null);
        Annuncio annuncio3 = new Annuncio(3l,"Lavatrice Whirlpool", "Via Garibaldi", "Roma", "00185", "Lavatrice con centrifuga", new BigDecimal("100.00"), "img3.jpg", Annuncio.EnumCategoria.ELETTRODOMESTICI, Annuncio.EnumCondizione.DISCRETA, Date.valueOf("2025-01-20"), user4, null, null);
        Annuncio annuncio4 = new Annuncio(4l,"Tagliaerba Bosch", "Via Veneto", "Diamante", "80122", "Tagliaerba elettrico", new BigDecimal("60.00"), "img4.jpg", Annuncio.EnumCategoria.GIARDINO, Annuncio.EnumCondizione.OTTIMA, Date.valueOf("2024-12-10"), user8, null, null);
        Annuncio annuncio5 = new Annuncio(5l,"Attrezzi da giardinaggio", "Via Dante", "Firenze", "50123", "Kit completo per giardinaggio", new BigDecimal("52.00"), "img5.jpg", Annuncio.EnumCategoria.GIARDINAGGIO, Annuncio.EnumCondizione.BUONA, Date.valueOf("2025-03-07"), user6, null, null);
        Annuncio annuncio6 = new Annuncio(6l,"Quadro moderno", "Via dei Fiori", "Bologna", "40121", "Dipinto astratto su tela", new BigDecimal("65.00"), "img6.jpg", Annuncio.EnumCategoria.ARTE, Annuncio.EnumCondizione.DISCRETA, Date.valueOf("2024-10-25"), user8, null, null);
        Annuncio annuncio7 = new Annuncio(7l,"Chitarra acustica", "Via 14 Settembre", "Arezzo", "15121", "Chitarra acustica Fender", new BigDecimal("77.00"), "img7.jpg", Annuncio.EnumCategoria.MUSICA, Annuncio.EnumCondizione.OTTIMA, Date.valueOf("2024-11-30"), user7, null, null);
        Annuncio annuncio8 = new Annuncio(8l,"Tostapane Bosch", "Via Vittorio Emanuele", "Palermo", "90123", "Tostapane a 4 fette", new BigDecimal("10.00"), "img8.jpg", Annuncio.EnumCategoria.CASAECUCINA, Annuncio.EnumCondizione.BUONA, Date.valueOf("2025-02-15"), user12, null, null);
        Annuncio annuncio9 = new Annuncio(9l,"Tapis roulant elettrico", "Via Gambardella", "Catania", "95121", "Tapis roulant, pieghevole con Altoparlante Bluetooth Integrato", new BigDecimal("47.00"), "img9.jpg", Annuncio.EnumCategoria.CASAECUCINA, Annuncio.EnumCondizione.BUONA, Date.valueOf("2025-05-12"), user13, null, null);
        Annuncio annuncio10 = new Annuncio(10l,"Computer portatile HP", "Corso Umberto", "Verona", "37123", "Notebook HP con processore i5", new BigDecimal("43.00"), "img10.jpg", Annuncio.EnumCategoria.ELETTRONICA, Annuncio.EnumCondizione.OTTIMA, Date.valueOf("2025-08-03"), user1, null, null);
        Annuncio annuncio11 = new Annuncio(11l,"Tavolo in legno", "Via della Moscova", "Milano", "20121", "Tavolo rettangolare in legno massiccio", new BigDecimal("50.00"), "img11.jpg", Annuncio.EnumCategoria.CASAECUCINA, Annuncio.EnumCondizione.BUONA, Date.valueOf("2024-12-20"), user11, null, null);
        Annuncio annuncio12 = new Annuncio(12l,"Scarpe da running", "Via Toledo", "Napoli", "80121", "Scarpe Nike da running, numero 42", new BigDecimal("7.00"), "img12.jpg", Annuncio.EnumCategoria.SPORT, Annuncio.EnumCondizione.OTTIMA, Date.valueOf("2025-03-25"), user12, null, null);
        Annuncio annuncio13 = new Annuncio(13l,"Fotocamera Canon", "Corso Italia", "Roma", "00192", "Canon EOS 80D con obiettivo", new BigDecimal("95.00"), "img13.jpg", Annuncio.EnumCategoria.ELETTRONICA, Annuncio.EnumCondizione.DISCRETA, Date.valueOf("2025-01-10"), user13, null, null);
        Annuncio annuncio14 = new Annuncio(14l,"Pentola a pressione", "Via Po", "Torino", "10163", "Pentola a pressione in acciaio", new BigDecimal("15.00"), "img14.jpg", Annuncio.EnumCategoria.CASAECUCINA, Annuncio.EnumCondizione.BUONA, Date.valueOf("2025-04-18"), user14, null, null);
        Annuncio annuncio15 = new Annuncio(15l,"Bicicletta da corsa", "Corso Garibaldi", "Bologna", "40122", "Bici da corsa Bianchi, taglia L", new BigDecimal("120.00"), "img15.jpg", Annuncio.EnumCategoria.SPORT, Annuncio.EnumCondizione.OTTIMA, Date.valueOf("2025-07-11"), user15, null, null);
        Annuncio annuncio16 = new Annuncio(16l,"Televisore Samsung", "Via XX Settembre", "Genova", "16121", "TV LED 55 pollici", new BigDecimal("200.00"), "img16.jpg", Annuncio.EnumCategoria.ELETTRONICA, Annuncio.EnumCondizione.DISCRETA, Date.valueOf("2024-11-05"), user1, null, null);
        Annuncio annuncio17 = new Annuncio(17l,"Tavola da surf", "Via Roma", "Cosenza", "90122", "Tavola da surf con accessori", new BigDecimal("150.00"), "img17.jpg", Annuncio.EnumCategoria.SPORT, Annuncio.EnumCondizione.BUONA, Date.valueOf("2025-02-20"), user2, null, null);
        Annuncio annuncio18 = new Annuncio(18l,"Robot da cucina", "Corso Vittorio Emanuele", "Sassari", "95121", "Robot da cucina multifunzione", new BigDecimal("90.00"), "img18.jpg", Annuncio.EnumCategoria.CASAECUCINA, Annuncio.EnumCondizione.OTTIMA, Date.valueOf("2024-10-15"), user3, null, null);
        Annuncio annuncio19 = new Annuncio(19l,"Chitarra elettrica", "Via dei Mille", "Verona", "37123", "Chitarra elettrica Gibson", new BigDecimal("170.00"), "img19.jpg", Annuncio.EnumCategoria.MUSICA, Annuncio.EnumCondizione.OTTIMA, Date.valueOf("2025-10-19"), user4, null, null);
        Annuncio annuncio20 = new Annuncio(20l,"About Love", "Via Fusco", "Salerno", "43765", "Libro di storie brevi scritto da Anton Chekhov", new BigDecimal("7.00"), "img20.jpg", Annuncio.EnumCategoria.LIBRI, Annuncio.EnumCondizione.OTTIMA, Date.valueOf("2025-06-19"), user5, null, null);
        Annuncio annuncio21 = new Annuncio(21l,"MacBook Pro", "Via della Moscova", "Milano", "20821", "MacBook Pro 13 pollici, 2020", new BigDecimal("185.00"), "img21.jpg", Annuncio.EnumCategoria.ELETTRONICA, Annuncio.EnumCondizione.OTTIMA, Date.valueOf("2025-01-05"), user6, null, null);
        Annuncio annuncio22 = new Annuncio(22l,"Giacca nera da ufficio", "Corso Magenta", "Torino", "10123", "Giacca nera da ufficio nera, taglia M da donna", new BigDecimal("10.00"), "img22.jpg", Annuncio.EnumCategoria.OGGETTISTICAPROFESSIONALE, Annuncio.EnumCondizione.BUONA, Date.valueOf("2025-04-15"), user7, null, null);
        Annuncio annuncio23 = new Annuncio(23l,"Forno a microonde", "Via Garibaldi", "Roma", "00185", "Forno a microonde Samsung", new BigDecimal("20.00"), "img23.jpg", Annuncio.EnumCategoria.ELETTRODOMESTICI, Annuncio.EnumCondizione.DISCRETA, Date.valueOf("2024-12-20"), user8, null, null);
        Annuncio annuncio24 = new Annuncio(24l,"Cassetta degli attrezzi", "Via Veneto", "Catania", "80122", "Cassetta per gli attrezzi vuota della DEWALT", new BigDecimal("20.00"), "img24.jpg", Annuncio.EnumCategoria.OGGETTISTICAPROFESSIONALE, Annuncio.EnumCondizione.BUONA, Date.valueOf("2025-03-01"), user9, null, null);
        Annuncio annuncio25 = new Annuncio(25l,"Tavolo da ping pong", "Via Dante", "Firenze", "50123", "Tavolo da ping pong con accessori", new BigDecimal("60.00"), "img25.jpg", Annuncio.EnumCategoria.SPORT, Annuncio.EnumCondizione.OTTIMA, Date.valueOf("2025-06-10"), user10, null, null);
        Annuncio annuncio26 = new Annuncio(26l,"Lettore MP3", "Via dei Mille", "Venezia", "40121", "Lettore MP4 Sony", new BigDecimal("7.00"), "img26.jpg", Annuncio.EnumCategoria.ELETTRONICA, Annuncio.EnumCondizione.BUONA, Date.valueOf("2024-11-30"), user11, null, null);
        Annuncio annuncio27 = new Annuncio(27l,"Tappeto persiano", "Corso Vittorio Emanuele", "Palermo", "90723", "Tappeto persiano fatto a mano", new BigDecimal("45.00"), "img27.jpg", Annuncio.EnumCategoria.ARTE, Annuncio.EnumCondizione.DISCRETA, Date.valueOf("2025-02-28"), user12, null, null);
        Annuncio annuncio28 = new Annuncio(28l,"Smartwatch Garmin", "Via XX Settembre", "Genova", "16141", "Smartwatch Garmin Venu", new BigDecimal("48.00"), "img28.jpg", Annuncio.EnumCategoria.ELETTRONICA, Annuncio.EnumCondizione.OTTIMA, Date.valueOf("2024-10-15"), user13, null, null);
        ...
        Noleggio noleggio6 = new Noleggio(6l,Noleggio.EnumStato.CONCLUSO, new BigDecimal("600.00"), Date.valueOf("2024-04-4"), Date.valueOf("2024-04-10"), Date.valueOf("2024-04-3"), user10, user8, annuncio6);
        Noleggio noleggio7 = new Noleggio(7l,Noleggio.EnumStato.CONCLUSO, new BigDecimal("700.00"), Date.valueOf("2024-04-3"), Date.valueOf("2024-04-8"), Date.valueOf("2024-04-2"), user9, user7, annuncio7);
        Noleggio noleggio8 = new Noleggio(8l,Noleggio.EnumStato.CONCLUSO, new BigDecimal("800.00"), Date.valueOf("2024-02-7"), Date.valueOf("2024-02-16"), Date.valueOf("2024-02-4"), user14, user12, annuncio8);
        Noleggio noleggio9 = new Noleggio(9l,Noleggio.EnumStato.CONCLUSO, new BigDecimal("900.00"), Date.valueOf("2024-03-01"), Date.valueOf("2024-03-04"), Date.valueOf("2024-02-27"), user15, user13, annuncio9);
        Noleggio noleggio10= new Noleggio(10l,Noleggio.EnumStato.CONCLUSO,new BigDecimal("99.00"), Date.valueOf("2024-03-09"),Date.valueOf("2024-03-15"), Date.valueOf("2024-03-03"), user10, user1, annuncio10);
        Noleggio noleggio11 = new Noleggio(11l,Noleggio.EnumStato.RICHIESTA, new BigDecimal("650.00"), Date.valueOf("2024-04-4"), Date.valueOf("2024-04-12"), Date.valueOf("2024-04-1"), user1, user2, annuncio1);
        Noleggio noleggio16 = new Noleggio(16l,Noleggio.EnumStato.RICHIESTA, new BigDecimal("600.00"), Date.valueOf("2024-04-02"), Date.valueOf("2024-04-11"), Date.valueOf("2024-03-28"), user1, user2, annuncio2);
        Noleggio noleggio12= new Noleggio(12l,Noleggio.EnumStato.RICHIESTA, new BigDecimal("700.00"), Date.valueOf("2024-04-5"), Date.valueOf("2024-04-8"), Date.valueOf("2024-04-1"), user9, user7, annuncio7);
        Noleggio noleggio13= new Noleggio(13l,Noleggio.EnumStato.RICHIESTA, new BigDecimal("800.00"), Date.valueOf("2024-02-7"), Date.valueOf("2024-02-16"), Date.valueOf("2024-02-4"), user14, user12, annuncio8);
